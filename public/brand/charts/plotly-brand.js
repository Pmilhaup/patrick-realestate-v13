...
(function () {
  ...
  function area(name, x, y, tone, opts) {
    ...
    return Object.assign({
      ...
      line: { color: c.line, width: opts.width || 1.25, shape: opts.shape || 'spline', smoothing: 1.3 },
  ...
  function line(name, x, y, tone, opts) {
    ...
    return Object.assign({
      type: 'scatter', mode: 'lines', name: name,
      x: x, y: y,
      line: { color: c.line, width: opts.width || 3, shape: opts.shape || 'spline', smoothing: 1.3 },
